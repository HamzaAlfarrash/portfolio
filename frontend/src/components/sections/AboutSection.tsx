      ...
      <div className="section-container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="heading-lg mb-6 opacity-0 animate-fade-in" style={{ animationDelay: '100ms' }}>
              Crafting Cloud Solutions with{' '}
              <span className="text-gradient">Precision & Purpose</span>
            </h2>
            <div className="space-y-4 text-muted-foreground opacity-0 animate-fade-in" style={{ animationDelay: '200ms' }}>
              <p>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {skills.map((skill, index) => (
              <div
                key={skill.title}
                className="p-6 rounded-xl bg-card border border-border hover:border-primary/50 transition-all duration-300 group opacity-0 animate-fade-in"
